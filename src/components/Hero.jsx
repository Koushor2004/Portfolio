          ...
          <div className="hero-card">
            <div className="hero-avatar-wrap">
              ...
              <div className="hero-avatar-placeholder">
                ...
                <span>Add avatar.jpg to /public/</span>
              </div>
            </div>
            <h2 className="hero-card-name">{personal.name}</h2>
            <div className="hero-card-icon">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
              </svg>
            </div>
            <p className="hero-card-bio">{personal.bio}</p>
            <div className="hero-card-social">
              ...
              {personal.social.instagram && (
                <a href={personal.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
